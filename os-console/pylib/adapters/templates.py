...
SUGGEST = {
    'prd-template.md': 'product-development/product/PRDs/{area}/{initiative}-product-brief.md',
    ...
    'micro-jobs-breakdown-template.md': 'product-development/product/PRDs/{area}/{initiative}-micro-jobs-breakdown.md',
    'job-spec-template.md': 'product-development/product/PRDs/{area}/{initiative}-{job}-micro-job.md',
}
